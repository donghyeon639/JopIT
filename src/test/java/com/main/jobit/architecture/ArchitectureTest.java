...
/**
 ...
 -   com.main.jobit.ai      — AI 어댑터 + 포트 (claude/feedback/port)
 -   com.main.jobit.infra   — 외부 시스템 어댑터 (현재 비어 있음)
 - com.main.jobit.global  — 횡단 관심사 (config/exception/security)
 -
 - 단계 3 시점의 기본 룰:
 -   1) domain은 ai.claude(LLM 구체 어댑터)를 직접 의존하지 않는다. ai.port 인터페이스만 통한다.
 -   2) ai.claude 어댑터는 도메인을 모른다.
